...
fun InfoScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Connected to ${uiState.chatroomId}") },
                navigationIcon = {
        ...
        LazyColumn(
            ...
            mapOf(
                "Disconnect from ${uiState.chatroomId}" to onBack,
                "Delete Chatroom ${uiState.chatroomId}" to { deleteChatroomClicked.value = true },
